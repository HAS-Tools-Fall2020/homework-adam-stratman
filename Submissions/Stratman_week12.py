...
kelvin_to_celsius = (two_week_mean - 273.15)

print("this is temperature in celsius", kelvin_to_celsius,)
# %%
# %%
...
prediction = model.intercept_ + model.coef_ * last_week_flow + (kelvin_to_celsius * model.coef_)
...
+ model2.coef_[1] * last2_week_flow + (kelvin_to_celsius * model.coef_)
...
plt.ylabel('Daily Average Temperature (Kelvin)', fontsize=18)
plt.xlabel('Time', fontsize= 20)
matplotlib.rc('xtick', labelsize=10)
matplotlib.rc('ytick', labelsize=10)
ax.set(title="Time Series For a Single Lat / Lon Location")
plt.savefig('air_timeseries.png')
# %%
